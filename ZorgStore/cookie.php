...
if (isset($_SESSION['user_id'])){
		...
		if (isset($_COOKIE[$user_id]) || $_COOKIE[$user_id]){ // not sure how to fix the "not an index" issue that happens when a new session begins and the cookie is first created, but when you reload the page, the cookie is recognized and the error goes away
